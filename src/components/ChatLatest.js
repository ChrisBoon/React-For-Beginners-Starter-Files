...
class ChatLatest extends React.Component{
  ...
  deleteChat(event){
    ...
    this.props.deleteChat(this.props.index)
  }
    ...
    if (this.props.currentUser.role==='teacher') {
      deleteButton = <div className="op2-chatLatest-delete">
                      <button type="submit" onClick={(e) => this.deleteChat(e)} className="op2-chatLatest-delete-button">Delete Chat 🚽</button>
                     </div>
    }
		return(
